...
const cardImages = [
  "/assets/Cell-images/z2.png",
  "/assets/Cell-images/z3.png",
  "/assets/Cell-images/z4.png",
  "/assets/Cell-images/z5.png",
  "/assets/Cell-images/z6.png",
  "/assets/Cell-images/z7.png",
];
